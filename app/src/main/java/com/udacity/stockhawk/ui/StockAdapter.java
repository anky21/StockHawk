...
class StockAdapter extends RecyclerView.Adapter<StockAdapter.StockViewHolder> {
    ...
    StockAdapter(Context context, StockAdapterOnClickHandler clickHandler) {
        ...
        percentageFormat.setPositivePrefix(context.getString(R.string.percentage_positive_prefix));
    }
    ...
    public void onBindViewHolder(StockViewHolder holder, int position) {
        ...
        holder.symbol.setContentDescription(context.getString(R.string.a11y_symbol, stockSymbol));

        String stockPrice = dollarFormat.format(cursor.getFloat(Contract.Quote.POSITION_PRICE));
        holder.price.setText(stockPrice);
        holder.symbol.setContentDescription(context.getString(R.string.a11y_price, stockPrice));
        ...
        if (PrefUtils.getDisplayMode(context)
            ...
            holder.change.setContentDescription(context.getString(R.string.a11y_percent_change, change));
